...
*Reducing uncertainty in stock assessments by billions of fish by using highest
density intervals* TODO decide
...
intervals (HDIs) to characterise uncertainty is preferable to using the usual
equal-tailed intervals. The HDIs are shorter (less uncertainty) and also lead to
unanticipated conservation implications in our example application.
