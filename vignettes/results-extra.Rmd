...
simple bimodal distribution of simulated data and calculate the a `quasi-HDI' using the moving-window approach:
...
with a low density (hence we call it a quasi-HDI), and the difference between the densities at the endpoints of
...
recommend investigating the use of quasi-HDIs or ETIs. TODO mention cod if include.
