...
## Example output from Pacific Hake stock assessment
...
Values in range a are `r colorize("just as likely")` as values in range b.

But a is `r colorize("outside")` the ETI yet b is `r colorize("inside")` it.
```{r eti2, echo = FALSE}
plot(res_vec,
     type = "eti",
     xlim = c(0, 40),
...
All values in range c are `r colorize("more")` likely than all in range d.
